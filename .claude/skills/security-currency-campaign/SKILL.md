...
- **`@vitest/mocker` (moderate)** — needs `vitest ^4.1.11`, another major. Dev-only, headless `vitest run`, never shipped. Deliberately not batched into the Next migration.
